...
const UserCard: React.FC<UserCardProps> = ({ username, color, ...props }) => {
    return (
        <div className={userCardVariant({ color })}
             ...
             {...props}>
            {/* Icono de Perfil */}
            <div className="flex items-center justify-center mr-4" style={{ width: '60px', height: '82.286px', flexShrink: 0 }}>
            ...
            {/* Nombre de Usuario */}
            <div className="flex flex-col justify-center items-start flex-1 text-lg font-bodyFont text-bodybold1 text-gray-900">
                {username}
            </div>
